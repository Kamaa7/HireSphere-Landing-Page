...
const linksArr = [
  {
    title: 'Services',
    links: ['Job Search', 'Career Coaching', 'Resume Review'],
  },
  {
    title: 'Industries',
    links: ['Technology', 'Finance', 'Healthcare'],
  },
  {
    title: 'Support',
    links: ['Contact us', 'FAQ', 'Resources'],
  },
];
        ...
        <FooterMainContent>
          <FooterMiddle>
            <QRContainer>
              ...
              <TextCtn>
                <p>Scan to download our Job Search App on the Playstore and Appstore.</p>
                <IconCtn>
