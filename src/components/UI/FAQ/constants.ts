...
export const faqData: FAQItem[] = [
  {
    question: 'How do I get started with Hire Sphere?',
    answer:
  ...
  {
    question: 'How does Hire Sphere ensure the confidentiality of my job search?',
    answer:
  ...
  {
    question: 'What types of positions does Hire Sphere specialize in?',
    answer:
  ...
  {
    question: 'What benefits does Hire Sphere offer for career development?',
    answer:
